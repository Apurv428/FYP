...
class _BeveragesState extends State<Beverages> {
  ...
  late List<Item> _beveragesList = [];
  late List<Item> _filteredBeveragesList = [];
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          _filteredBeveragesList = _beveragesList
            ...
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                if (snapshot.hasData) {
                  ...
                  if (_filteredBeveragesList.isEmpty) {
                    _filteredBeveragesList = _beveragesList;
                  }

                  return GridView.builder(
                    itemCount: _filteredBeveragesList.length,
                    gridDelegate:
                    ...
                    itemBuilder: (context, index) {
                      return SingleMenu(
                        item: _filteredBeveragesList[index],
                      );
                    },
                  );
                }
