...
class _LunchState extends State<Lunch> {
  ...
  late List<Item> _lunchList = [];
  late List<Item> _filteredLunchList = [];
            ...
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                if (snapshot.hasData) {
                  ...
                  if (_filteredLunchList.isEmpty) {
                    _filteredLunchList = _lunchList;
                  }

                  return GridView.builder(
                    itemCount: _filteredLunchList.length,
                    gridDelegate:
